...
@section('html_title')
    <title>Accounts Receivable - FASTWEB ERP</title>
...
@section('title_header')
    <x-header title="Accounts Receivable" />
@endsection
    ...
    <div class="d-flex">
        ...
        <div class="mb-1 whMoverangeDiv">
            ...
            <div id="dateRange" style="background: var(--background-color, #fff); cursor: pointer; padding: 8px 12px; border-radius: 0.375rem; width: 100%">
                <input type="text" id="soNumberFilter" placeholder="Enter SO number">
            </div>
        </div>
        <div class="mb-1 whMoverangeDiv">
            <label class="form-label">CUSTOMER</label>
            <div id="customerFilter_VS" class="VSSelect"></div>
        </div>
        <div class="mb-1 whMoverangeDiv">
        ...
        <div class="col-sm-12 col-md-3">
            <div class="containerStyle">
                <div class="d-flex mx-3 stockOut">
                    ...
                    <div class="contentDiv">
                        <span class="contentTitle">Total Settled</span>
                        <p class="contentValue" id="total-invoices">₱--- Settled</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-sm-12 col-md-3">
            <div class="containerStyle">
                <div class="d-flex mx-3 totalProfit">
                    ...
                    <div class="contentDiv">
                        <span class="contentTitle">Overdue Amount</span>
                        <p class="contentValue" id="total-credit">₱--- Overdue</p>
                    </div>
                </div>
            </div>
        </div>
...
@section('table')
    <style>
        ...
        /* Accounts Receivable Modal Custom Styling - Matching Accounts Payable Modal */
        #accountsReceivableModal .modal-dialog {
            max-width: 550px !important;
            width: 550px !important;
        }

        #accountsReceivableModal .modal-content {
            border-radius: 12px;
        ...
        #accountsReceivableModal .modal-body {
        ...
        #accountsReceivableModal .form-control:focus,
        #accountsReceivableModal .form-select:focus {
            border-color: #5188FD;
            box-shadow: 0 0 0 0.2rem rgba(81, 136, 253, 0.1);
            outline: none;
        }

        #accountsReceivableModal .form-check-input:checked {
        ...
        #accountsReceivableModal .btn:focus {
            box-shadow: 0 0 0 0.2rem rgba(81, 136, 253, 0.25);
        }

        /* Poppins font for entire accounts receivable modal */
        #accountsReceivableModal,
        #accountsReceivableModal * {
            font-family: 'Poppins', sans-serif !important;
        }

        #accountsReceivableModal .modal-title {
            font-family: 'Poppins', sans-serif !important;
            font-weight: 600 !important;
            color: #333 !important;
        }

        /* Section title styling to match AP modal */
        #accountsReceivableModal .arheaderSectionTitle {
            font-family: 'Poppins', sans-serif !important;
        ...
        #accountsReceivableModal .section-divider {
        ...
        /* Form labels styling */
        #accountsReceivableModal .form-label {
            font-family: 'Poppins', sans-serif !important;
        ...
        /* Input field styling to match AP modal */
        #accountsReceivableModal .form-control {
            font-family: 'Poppins', sans-serif !important;
        ...
        #accountsReceivableModal .form-select {
            font-family: 'Poppins', sans-serif !important;
        ...
        /* Read-only fields styling to match AP modal */
        #accountsReceivableModal .form-control[readonly] {
        ...
        /* Textarea styling */
        #accountsReceivableModal textarea.form-control {
        ...
        #accountsReceivableModal #total_amount {
            background-color: #e3f2fd !important;
            font-weight: 600 !important;
            color: #1976d2 !important;
        }

        #accountsReceivableModal #balance_amount {
            background-color: #ffebee !important;
            font-weight: 600 !important;
            color: #d32f2f !important;
        }

        #accountsReceivableModal #credit_memo {
        ...
        /* Section dividers */
        #accountsReceivableModal .d-flex.align-items-center hr {
            border-color: #dee2e6 !important;
            margin: 0 !important;
        }

        /* Row spacing */
        #accountsReceivableModal .row.mb-2 {
            margin-bottom: 1rem !important;
        }

        #accountsReceivableModal .row.mb-3 {
            margin-bottom: 1.5rem !important;
        }

        /* Button styling */
        #accountsReceivableModal .btn {
            font-family: 'Poppins', sans-serif !important;
            font-weight: 500 !important;
        ...
        /* Modal footer */
        #accountsReceivableModal .modal-footer {
            background: #ffffff !important;
            border-top: 1px solid #dee2e6 !important;
        ...
        #accountsReceivableModal .modal-footer .d-flex {
            align-items: center !important;
        }

        #accountsReceivableModal .modal-footer .btn {
            margin: 0 !important;
        }
    ...
    <x-contentButtonDiv downloadFunc="true" :addFunc="false">
        <x-slot:additionalButtons>
            ...
            <div class="btn d-flex justify-content-around px-2 align-items-center me-1 actionBtn" id="arPrintAllBtn">
    ...
    <x-table id="AccountsReceivableTable">
        <x-slot:td>
...
@section('modal')
    <x-mainModal mainModalTitle="accountsReceivableModal" modalDialogClass="modal-lg" modalHeaderTitle="ACCOUNTS RECEIVABLE RECORD" modalSubHeaderTitle="View and manage accounts receivable record details.">
        <x-slot:form_fields>
            <div class="arheaderform">
                <form id="accountsReceivableForm">
                    <!-- Transaction Information Section -->
                    <div class="mb-1">
                        <div class="d-flex align-items-center">
                            <div class="arheaderSectionTitle">TRANSACTION INFORMATION</div>
                    ...
                    <div class="row mb-2">
                        <div class="col-12 col-sm-6 col-md-6">
                            <div class="">
                                ...
                                <input type="text" class="form-control" id="customer_display" name="customer_display" readonly>
                                <div id="customer_code_VS" name="customer_code" class="form-control bg-white p-0 border-0" style="display: none;"></div>
                            </div>
                        </div>
                        <div class="col-12 col-sm-6 col-md-6">
                            <div class="">
                    ...
                    <div class="mb-1">
                        <div class="d-flex align-items-center">
                            <div class="arheaderSectionTitle">REFERENCE INFORMATION</div>
                            <div class="flex-grow-1 ms-3">
                                <hr class="section-divider">
                            </div>
                        </div>
                    ...
                    <div class="mb-1">
                        <div class="d-flex align-items-center">
                            <div class="arheaderSectionTitle">FINANCIAL INFORMATION</div>
                            <div class="flex-grow-1 ms-3">
                                <hr class="section-divider">
                            </div>
                        </div>
...
<script src="{{ asset('assets/js/accounts-receivable/accounts-receivable.js') }}"></script>
