...
@section('title_header')
    <x-header title="Bank Reconciliation" />
@endsection
...
@section('modal')
    <style>
        ...
        /* Bank Reconciliation Modal Styling - matching Supplier Credit design */
        .bankModalForm .row div div label {
            font-size: 0.53em;
            margin-bottom: 0;
        ...
        .bankModalForm .row div div input,
        .bankModalForm .row div div div {
            font-size: 0.68em;
            margin-bottom: 0;
            font-family: var(--body-font, "Inter", sans-serif);
            color: var(--text-color, #212529);
        ...
        .bankModalForm .form-control.border-0 {
    ...
    <x-mainModal mainModalTitle="beginningBalanceModal" modalDialogClass="" modalHeaderTitle="<span style='color: var(--primary-color, #0275d8);'>SET BEGINNING BALANCE</span>" modalSubHeaderTitle="Set the starting balance for this bank account">
        <x-slot:form_fields>
            <div id="beginningBalanceFields">
                <input type="hidden" id="BalanceBankID">
                <div class="row">
                    <div class="col-12 mb-3">
                        <label class="fw-bold">Bank: <span id="balanceBankName" class="text-primary"></span></label>
                    </div>
                    <div class="col-12 mb-3">
                        <label class="fw-bold">Account: <span id="balanceAccountName"></span></label>
                    </div>
                    <div class="col-6">
                        <div class="mb-3">
    ...
    <!-- Bank Details & Transaction History Modal -->
    <x-mainModal mainModalTitle="bankDetailsModal" modalDialogClass="modal-xl" modalHeaderTitle="<span style='color: var(--primary-color, #0275d8);'>BANK RECONCILIATION DETAILS</span>" modalSubHeaderTitle="">
        <x-slot:form_fields>
            <div class="bankModalForm">
                <input type="hidden" id="DetailsBankID">
                
                <!-- Bank Information Section -->
                <div id="bankDetailsSection">
                    <div class="d-flex align-items-center" style="margin-bottom:-10px;">
                        <div style="width:100%;"><hr></div>
                        <div class="bankSectionTitle">BANK INFORMATION:</div>
                        <div style="width:100%;"><hr></div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-12 col-sm-6 col-md-3">
                            <div class="">
                                <label for="detailsBankName" class="form-label">BANK NAME</label>
                                <input type="text" disabled id="detailsBankName" name="detailsBankName" class="form-control" readonly>
                            </div>
                        </div>
                        <div class="col-12 col-sm-6 col-md-3">
                            <div class="">
                        ...
                        <div class="col-12 col-sm-6 col-md-3">
                            <div class="">
                                <label for="detailsAccountType" class="form-label">ACCOUNT TYPE</label>
                                <input type="text" disabled id="detailsAccountType" name="detailsAccountType" class="form-control" readonly>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div id="reconciliationSummarySection">
                    <div class="d-flex align-items-center" style="margin-bottom:-10px;">
                        <div style="width:100%;"><hr></div>
                        <div class="bankSectionTitle">RECONCILIATION SUMMARY:</div>
                        <div style="width:100%;"><hr></div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-12 col-sm-6 col-md-3">
            ...
            <div id="transactionHistorySection">
                <div class="d-flex align-items-center" style="margin-bottom:-10px;">
                    <div style="width:100%;"><hr></div>
                    <div class="bankSectionTitle">TRANSACTION HISTORY:</div>
                    <div style="width:100%;"><hr></div>
                </div>
                ...
                <div id="noTransactionsMessage" class="text-center py-4" style="display: none;">
                    <p class="text-muted">No transactions found for this bank.</p>
                </div>
            </div>
        </x-slot:form_fields>
        <x-slot:modalFooterBtns>
...
@section('pagejs')
    ...
    <script src="{{ asset('assets/js/bank_reconciliation/bank_reconciliation.js') }}"></script>
@endsection
