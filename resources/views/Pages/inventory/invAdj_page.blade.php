...
@section('modal')
    ...
    <x-mainItemModal>
        <x-slot:customFields>
            <div class="col-4">
                <div class="">
                    <label for="actualStock" class="form-label">Current Stock Quantity</label>
                    <input disabled type="text" id="actualStock" name="actualStock" class="form-control" required placeholder="Actual Stock Count">
                </div>
            </div>
        </x-slot:customFields>
    </x-mainItemModal>
