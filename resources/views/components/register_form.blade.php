<div class="p-6 space-y-6">
    ...
    <form id="register" class="space-y-4" onsubmit="return false;">
        <div class="flex flex-col mb-3 space-y-6 md:flex-row md:space-y-0 md:space-x-6">
            <div class="w-full">
        ...
        <div>
            ...
            <div class="flex items-stretch">
                ...
                <input type="text" id="mobile" name="mobile" required class="flex-1 px-4 py-2 border border-gray-300 rounded-r-lg focus:ring-blue-500 focus:border-blue-500" maxlength="10" inputmode="numeric" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
            </div>
        </div>
