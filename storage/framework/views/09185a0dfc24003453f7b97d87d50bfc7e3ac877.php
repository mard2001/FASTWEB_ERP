...
<body>
    ...
    <?php $__currentLoopData = $report; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <?php endif; ?>                   
                    <tr>
                        <td style="width: 5%;" class="text-center"><?php echo e($rowCount+1); ?></td>
                        <td style="width: 15%;"><?php echo e($item['StockCode'] ?? ''); ?></td>
                        <td style="width: 50%;"><?php echo e($item['Description']?? ''); ?></td>
                        
                        <td style="width: 10%;" class="text-center">
                            <?php echo e(isset($item['ConvResult']['inCS']) && $item['ConvResult']['inCS'] > 0 ? $item['ConvResult']['inCS'] : ''); ?>

                        </td>
                        <td style="width: 10%;" class="text-center">
                            <?php echo e(isset($item['ConvResult']['inIB']) && $item['ConvResult']['inIB'] > 0 ? $item['ConvResult']['inIB'] : ''); ?>

                        </td>
                        <td style="width: 10%;" class="text-center">
                            <?php echo e(isset($item['ConvResult']['inPC']) && $item['ConvResult']['inPC'] > 0 ? $item['ConvResult']['inPC'] : ''); ?>
...
</html><?php /**PATH C:\xampp\htdocs\bckup_FASTERP\backupFASTERP_2025-03-17\resources\views/Pages/Printing/CountSheet_printing.blade.php ENDPATH**/ ?>