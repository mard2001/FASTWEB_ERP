    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content w-100 h-100">
            <div class="modal-header py-0">
                <div>
                    <p class="text-nowrap my-0" style="font-size: 1.5em; font-weight: bold; color: #33336F;">SALES ORDER</p>
                    <small>Sales Order Entry & Details</small>
                </div>
...
</div><?php /**PATH C:\xampp\htdocs\bckup_FASTERP\FASTERP_2025-03-17\resources\views/components/so_modal.blade.php ENDPATH**/ ?>