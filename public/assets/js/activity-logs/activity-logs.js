                ...
                MainTH = $('#ActivityLogTable').DataTable({
                    ...
                    columns: [
                        ...
                        { 
                            ...
                            render: function (data, type, row) {
                                if (!data || data === null || data === undefined) {
                                    return '<span style="font-size:10px; color:#808080;">---</span>';
                                }
                    ...
                    <table style="font-size: 14px">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <th class="px-2"><span class="${getActivityBadgeClass(activity.event)}">${capitalizeFirst(activity.event)}</span></th>
                            </tr>
                        </tbody>
                    </table>
                </div>
                    ...
                    <table style="font-size: 14px">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <th class="px-2"><span style="font-weight: 550">${getModuleName(activity.subject_type || '')}</span></th>
                            </tr>
                            <tr>
                                <td style="white-space: nowrap;">Subject ID:</td>
                                <th class="px-2"><code>${activity.subject_id || '-'}</code></th>
                            </tr>
                            <tr>
                        ...
                        <table class="table table-sm" style="font-size: 12px">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><small>${activity.subject_type || '-'}</small></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
